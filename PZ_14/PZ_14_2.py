...
def solve():
    ...
    result.insert(END, "\n")
    result.insert(END, "В каких магазинах можно приобрести одновременно молоко, печенье и сыр:\n")
    ...
    if "молоко" in lenta and "печенье" in lenta and "сыр" in lenta:
        result.insert(END, "Лента\n")
    result.insert(END, "\n")
    result.insert(END, "В каких магазинах можно приобрести мясо и молоко:\n")
    ...
    if "мясо" in lenta and "молоко" in lenta:
        result.insert(END, "Лента\n")
label = Label(root, text="Задача о магазинах", font=("Arial", 14))
label.pack(pady=10)
